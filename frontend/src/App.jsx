...
const App = () => {
  const {authUser,isLoading,error}=useAuthUser();//custom hook
  ...
  return (
    <div className="h-screen text-2xl" data-theme={theme}>
      <Routes>
        {/* pass showSidebar parameter to HomePage */}
        ...
        <Route path="/onboarding" element={isAuthenticated? (!isOnboarded ? <OnboardingPage /> : <HomePage/> ) : <Navigate to="/login" />} />
